...
defined('MODULE_CATEGORIES_MITS_PRODUCTSIMAGEFILENAMES_ADD_ID_DESC') or define('MODULE_CATEGORIES_MITS_PRODUCTSIMAGEFILENAMES_ADD_ID_DESC', 'Soll die Artikel-ID (products_id) in den Dateinamen integriert werden? <small>Dies geschieht automatisch bei Dateiname bilden = None.</small>');
...
defined('MODULE_CATEGORIES_MITS_PRODUCTSIMAGEFILENAMES_ADD_COUNTER_DESC') or define('MODULE_CATEGORIES_MITS_PRODUCTSIMAGEFILENAMES_ADD_COUNTER_DESC', 'Soll der Bildz&auml;hler in den Dateinamen integriert werden? Empfohlen um Verwechslungen zu vermeiden, geschieht automatisch bei Dateiname bilden = None.');
